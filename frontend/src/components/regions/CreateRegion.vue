...
<template>
  <span>
    <TarButton icon="fas fa-plus" :text="t('actions.create')" variant="success" data-bs-toggle="modal" data-bs-target="#create-region" />
    <TarModal :close="t('actions.close')" id="create-region" ref="modalRef" size="large" :title="t('regions.create')">
